    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.picasso_fragment_button_1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Zipper.bind(new PicassoViewModel("https://www.android.com/static/img/android.png"), getView());
            }
        });
        ...
        view.findViewById(R.id.picasso_fragment_button_2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Zipper.bind(new PicassoViewModel("https://www.google.se/images/branding/googleg/1x/googleg_standard_color_128dp.png"), getView());
            }
        });
